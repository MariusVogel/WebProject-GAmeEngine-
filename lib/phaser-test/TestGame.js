...
function preload() {
    ...
    this.load.spritesheet('slime', 'src/assets/slime.png', {frameWidth: 28, frameHeight: 28});
...
function create() {
    this.add.image(400, 350, 'sky').setScale(6);

    platforms = this.physics.add.staticGroup();

    platforms.create(400, 1055, 'ground').setScale(8).refreshBody();

    platforms.create(350, 750, 'ground');
    platforms.create(650, 750, 'ground');
    platforms.create(1600, 750, 'ground');
    platforms.create(1200, 750, 'ground');

    platforms.create(950, 550, 'ground');
    platforms.create(1800, 550, 'ground');
    platforms.create(0, 550, 'ground');

    platforms.create(450, 375, 'ground');
    platforms.create(1200, 375, 'ground');
    platforms.create(1800, 375, 'ground');
    ...
    scoreText = this.add.text(0, 0, 'Score: 0', {fontSize: '32px', fill: '#000', align: "center"});
